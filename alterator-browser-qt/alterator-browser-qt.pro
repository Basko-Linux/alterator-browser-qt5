...
#CONFIG += no_keywords
CONFIG += debug
DEFINES += HAVE_X11 PROGRAM_VERSION=\'\"$$VERSION\"\'
QMAKE_CXXFLAGS += -pedantic $(RPM_OPT_FLAGS) -DQT_USE_FAST_CONCATENATION -DQT_USE_FAST_OPERATOR_PLUS -DQT_NO_CAST_TO_ASCII -DQT_NO_CAST_FROM_ASCII -DQT_USE_QSTRINGBUILDER
...
SOURCES =  main.cc
SOURCES += 3dparty/flowlayout.cpp 3dparty/waitingspinnerwidget.cpp
SOURCES += popup.cc fileselect.cc logo_icon.cc printfilter.cc
...
HEADERS += 3dparty/flowlayout.h 3dparty/waitingspinnerwidget.h
HEADERS += popup.hh fileselect.hh logo_icon.hh printfilter.hh
